...
import todo from '/assets/todo_shot.png';
import shortly from '/assets/shortly_shot.png';
import allaroundtheworld from '/assets/allaroundtheworld_shot.png';
import IPTrackify from '/assets/trackify_shot.png';
...
export default [
...

  {
    ...
    content: 'A simple calculator app that allows users to perform basic arithmetic operations. This app is built using HTML, CSS, and JavaScript.',
    techStacks: ['HTML', 'JS', 'SASS'],
